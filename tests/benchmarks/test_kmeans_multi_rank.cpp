...
TEST(kMeansAlgorithm, updateCenters) {
    ...
    { // Updating centers works with distributed data - centers already optimal
        ...
        auto kmeansInstance = kMeansAlgorithm<double>(std::move(data), 1);
...
TEST(kMeansAlgorithm, slightlyLargerExampleDistributedData) {
    ...
    switch (rank()) {
        ...
        case 2:
            data = {
                1.042,  1.208,  1.824,  2.033,  -0.082, -0.052, 0.910,  0.996,  2.004,  2.134,  -0.082, 0.153,  -0.075,
                0.136,  1.078,  1.035,  2.013,  1.968,  0.174,  -0.006, -0.072, 0.002,  1.147,  0.961,  1.952,  1.947,
                0.051,  0.048,  -0.087, -0.127, 2.076,  2.166,  1.932,  1.960,  -0.015, -0.056, 0.997,  0.833,  1.049,
                0.886,  2.059,  2.220,  1.081,  0.999,  1.032,  1.001,  0.892,  1.078,  1.929,  1.969,  0.810,  1.012,
                1.287,  0.992,  2.045,  2.056,  -0.009, -0.049, -0.136, 0.046,  0.934,  1.020,  0.973,  0.963,  0.118,
                -0.025, 1.982,  1.971,  1.959,  1.964,  -0.014, 0.017,  0.017,  0.122,  0.916,  1.063,  -0.020, -0.087,
                0.020,  -0.145, 0.992,  0.957,  1.990,  1.909,  0.959,  1.013,  -0.008, 0.038,  0.985,  0.986,  0.042,
                -0.013, 0.096,  -0.013, 0.069,  -0.137, 0.115,  0.119,  2.118,  2.105,  0.952,  1.005,  2.065,  1.884,
                -0.056, -0.111, 0.104,  -0.026, 1.901,  1.851,  -0.128, 0.003,  1.961,  1.941,  1.086,  0.951,  1.933,
                1.960,  2.026,  2.178,  0.889,  0.845,  1.153,  0.894,  0.106,  0.039,  0.993,  1.106,  1.016,  1.036,
                -0.248, -0.030, 1.865,  1.974,  1.139,  1.005,  1.077,  1.001,  0.005,  0.074,
            };
            break;
        case 3:
    ...
    auto kMeansInstance = kMeansAlgorithm<double>(std::move(data), 2);

    kMeansInstance.setCenters({2.045, 1.987, 1.589, 0.764, -0.12, 0.43});
    kMeansInstance.performIterations(10);
    kMeansInstance.collectClusterAssignments();
    ASSERT_THAT(
        kMeansInstance.pointToCenterAssignment().assignedCenter,
        ElementsAre(
            0, 0, 0, 0, 0, 0, 0, 2, 0, 2, 2, 1, 1, 1, 1, 0, 1, 2, 1, 1, 1, 2, 2, 2, 2, 2, 2, 0, 2, 0, 1, 1, 0, 0, 2, 1,
